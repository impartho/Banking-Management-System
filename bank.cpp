...
void account::Open_account()
{
	...
	cin>>type;
	type=toupper(type);
	cout<<"\nPlease! Enter The Initial amount(>=500 for Saving and >=500  for current ) : ";
	...
	cout<<"\n\nAccount Created..";}
		...
		cout<<"Please enter above 500"<<endl;
	}
}
...
void intro()
{
	...
	cout<<"\n\t\tMANAGEMENT";
	cout<<"\n\t\t  SYSTEM";
	cout<<"\n\nMADE BY : Partho Kumar Saha";
	cout<<"\nCOLLEGE : Lovely Professional University, Punjab, India";
	cin.get();
}
